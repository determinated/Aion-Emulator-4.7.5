...
public class StaticData {
    ...
    private void afterUnmarshal(Unmarshaller unmarshaller, Object parent) {
        ...
        DataManager.log.info("[DataManager] Loaded " + cubeExpandData.size() + " cube expand entries");
        ...
        DataManager.log.info("[DataManager] Loaded " + curingObjectsData.size() + " curing Objects entries");
        ...
        DataManager.log.info("[DataManager] Loaded " + abyssRaceBonusData.size() + " abyss race bonus entries");
        ...
        DataManager.log.info("[DataManager] Loaded " + loginEventData.size() + " atreian passports");
        ...
        DataManager.log.info("[DataManager] Loaded " + battlegroundData.size() + " battleground templates");
    }
}
